...
# =========================================================================
# 2. DEFINICIÓN DEL DETECTOR Y DINÁMICA
# =========================================================================
R_tube = 1.0     
R_anode = 0.002  
axis_lim = 1.2
...
hConteos = ROOT.TH1F("hConteos", "Distribucion de Landau: Electrones Primarios;Numero de Electrones;Frecuencia", 60, 0, 1000)

registro_conteos = [] # Lista para almacenar los datos crudos

# =========================================================================
# 4. BUCLE DE EXCITACIONES INDIVIDUALES
# =========================================================================
print(f"\n--- Iniciando simulaciones individuales ({n_eventos} Eventos) ---")
...
for i in range(n_eventos):
    ...
    electrones_primarios_evento = 0
    for cluster in track.GetClusters():
        for electron in cluster.electrons:
            electrones_primarios_evento += 1
            if i == 0:
                drift.DriftElectron(electron.x, electron.y, electron.z, electron.t)
                
    # Llenar el histograma
    hConteos.Fill(electrones_primarios_evento)
    
    # Guardar en la lista para el CSV
    registro_conteos.append(electrones_primarios_evento)
...
with open("/home/daniel/Workspace/Repositorios/ProyectoFiscomp1/data/outputs/conteos_muones_170GeV.csv", mode="w", newline="") as archivo_csv:
    escritor = csv.writer(archivo_csv)
    escritor.writerow(["Evento", "Electrones_Primarios"])
    for i, conteo in enumerate(registro_conteos):
        escritor.writerow([i + 1, conteo])
print("Archivo 'conteos_muones_170GeV.csv' guardado exitosamente.")

# =========================================================================
# 6. DIBUJO ESTRUCTURADO (LIENZOS INDEPENDIENTES)
# =========================================================================
...
cHist = ROOT.TCanvas("cHist", "Histograma de Conteos (100 Muones)", 700, 500)
cHist.cd()
hConteos.SetFillColor(ROOT.kBlue - 7)
hConteos.SetLineColor(ROOT.kBlue + 2)
hConteos.Draw()
cHist.Update()
